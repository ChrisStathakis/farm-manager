    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('taxes_modifier', models.CharField(choices=[('a', 0), ('b', 13), ('c', 24)], max_length=1, verbose_name='a')),
                ('value', models.DecimalField(decimal_places=2, default=0, max_digits=20, verbose_name='Αξία')),
                ('clean_value', models.DecimalField(decimal_places=2, default=0, max_digits=20, verbose_name='ΚΑΘΑΡΗ ΑΞΙΑ')),
                ('total_taxes', models.DecimalField(decimal_places=2, default=0, max_digits=20, verbose_name='Φόροι')),
