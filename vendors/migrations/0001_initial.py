    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('taxes_modifier', models.CharField(choices=[('a', 0), ('b', 13), ('c', 24)], default='c', max_length=1, verbose_name='ΦΠΑ')),
            ],
            options={
                'ordering': ['title'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clean_value', models.DecimalField(decimal_places=2, default=0.0, max_digits=20, verbose_name='ΚΑΘΑΡΗ ΑΞΙΑ')),
                ('total_taxes', models.DecimalField(decimal_places=2, default=0.0, max_digits=20, verbose_name='ΑΞΙΑ ΦΟΡΩΝ')),
